R"=====(
  <form id="form" name="config" action="">
    ...
    <fieldset>
      ...
      <label for="devList">Enable Track Whitelist</label><br>
      <table id="devList" style="margin-left: auto; margin-right: auto;">
        <tbody>
        <tr><th>Battery</th><th>Device</th><th>Action</th></tr>
        </tbody>
      </table>
    </fieldset>
